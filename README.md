...
**Frontend:**  
React.js | Next.js | Tailwind CSS | TypeScript | Material UI | CSS | HTML5

**Backend:**  
Node JS | Express JS | REST APIs | JWT Auth | TypeScript

**Database:**  
MongoDB | PostgreSQL | Mongoose | Prisma

**Others:**  
Git | GitHub | Gitlab | JIRA | Trello | SEO Optimization | API Integration
