...
const AboutMeSection = () => {
    ...
    return (
        <div
            id='about'
            className='w-full flex justify-center dark:bg-[#040B1C] section-bg items-center pt-28'
        >
                ...
                <div className='w-full flex flex-col lg:flex-row items-center gap-y-12 lg:justify-between'>
                    ...
                    <div className='w-full lg:w-[48%] gap-y-6 flex flex-col px-4'>
                        ...
                        <p className='text-lg text-justify text-[#64748b] leading-relaxed'>
                            I specialize in building dynamic, scalable web applications using the MERN stack. My passion lies in solving complex problems through clean, efficient code and delivering exceptional user experiences.
                        </p>
                        <p className='text-lg text-justify text-[#64748b] leading-relaxed'>
